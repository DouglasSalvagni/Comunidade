...
import { CourseChatMessage } from '@/modules/ai/entities/course-chat-message.entity';
import { CourseChatSummary } from '@/modules/ai/entities/course-chat-summary.entity';
